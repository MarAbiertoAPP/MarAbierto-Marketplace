const NFTs = [
  ...
  {
    title: 'Wavelength #62',
    description: "Wavelength, an evolving code which stemmed from an idea about our brain's electrical activity and how a thought can spark millions of connections within our neural pathway. Creating the bridge between code and our brains functionality is a fascinating idea which relates on a extremely relative scale.",
    price: 1,
  ...
  {
    title: 'InC #54',
    description: "A tribute to the musical piece 'In C' composed by Terry Riley in 1964. A multi-year Tanztheater project, directed by established choreographer Barbara Altissimo. A random walk through the canvas whose outcome is a series of short design fragments, composed for an indefinite number of performers/collectors, much like the original composition by Terry Riley. All in all, InC is my little contribution to beauty. 25% of the proceeds will be donated to local non-profit organizations dedicated to spreading beauty and helping talented and needy people.",
    price: 0.9,
  ...
  {
    title: 'Fjäll #336',
    description: 'Fjäll explores memories of nature utilising many tiny shapes where a hash value is used to generate a procedural topography and an accompanying perspective. Each token is represented by a unique landscape and accompanying perspective where colour and shapes blend together to form the final view.',
    price: 0.28,
  ...
  {
    title: 'Swamp Thing',
    description: '120 hand-generated, animated plots from #LykeIsland, a mysterious island with some strange goings on...',
    price: 1.5,
  ...
  {
    title: 'Bent #280',
    description: 'Lines are bent and shaded. There are no wrong turns. [Interaction in live view: press 1-7 or left/right arrow keys to see the stages of sketch construction: 1-grid, 2-divide, 3-tile, 4-bend, 5-shade, 6-color, 7-texture].',
    price: 1.9,
  ...
  {
    title: 'Future',
    description: 'The first 10 cards exist as a collection, and tell a story that has since been forgotten, unless you can track it down',
    price: 0.34,
  ...
  },
  {
    ...
    description: 'Join Cold Blooded Creepz in a multi season play-to-yield game. Build your army, secure your loot and climb the ranks in the $illuminati.',
    price: 1.2,
  ...
  {
    title: 'Rick and Morty',
    description: 'Welcome all Rick and Morty from the multiverses',
    price: 0.04,
  ...
  },
  {
    ...
    description: 'Rick and Morty Scene from the first chapter of the grimy version of the first season.',
    price: 0.03,
