        ...
        user && user.typeUser === 'SU' ? (
            <div className=' w-full max-w-screen-xl  flex h-screen max-h-limitHnewHome'>
              <div className='basis-3/12 min-h-full shadow-2xl shadow-purple-700 flex flex-col items-center'>
                ...
                <div
                  className='p-8 text-center border border-xl border-t-transparent border-x-transparent border-neutral-300'>
                ...
                <div className='flex flex-col w-full my-14 space-y-10'>
                  ...
                  <button onClick={handleRendering2} value='Reports'
                          className='p-4 mx-4 text-center rounded-2xl border-xl bg-purple-900  border-neutral-300 hover:bg-purple-700'>
                    <h1 className='text-2xl text-neutral-300'>Reports</h1>
                  </button>

                  <button onClick={handleRendering3} value='Users'
                          className='p-4 mx-4 text-center rounded-2xl border-xl bg-purple-900  border-neutral-300 hover:bg-purple-700'>
                    <h1 className='text-2xl text-neutral-300'>Users</h1>
                  </button>

                  <button onClick={handleRendering5} value='NFTs'
                          className='p-4 mx-4 text-center rounded-2xl border-xl bg-purple-900  border-neutral-300 hover:bg-purple-700'>
                    <h1 className='text-2xl text-neutral-300'>NFTs</h1>
                  </button>

                  <button onClick={handleRendering4} value='Collections'
                          className='p-4 mx-4 text-center rounded-2xl border-xl bg-purple-900  border-neutral-300 hover:bg-purple-700'>
